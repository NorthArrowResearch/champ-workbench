        ...
        <div class="container">
          ...
          <div class="panel panel-default"> 
            ...
            <div class="panel-body">
              ...
              <p>According to the crew, the majority of the point edits occurred <span class="response"><xsl:value-of class="response" select="/surveyGDB/tables/table/records/record[QuestionID = 'Q01']/Response" /></span> and the majority of the edits to the breaklines (hard and soft) occurred <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q02']/Response" /></span>.</p>
              <p>There <span class="response"><xsl:value-of select="/surveyGDB/tables/table/records/record[QuestionID = 'Q03']/Response" /></span> rod height busts in the original survey.</p>
              <p>Additional notes on rod heights: <span class="response"><xsl:value-of select="/surveyGDB/tables/table/records/record[QuestionID = 'Q03']/Notes" /></span>.</p>
          ...
          <div class="panel panel-default"> 
            ...
            <div class="panel-body">
              ...
              <p>'<span id="final-tin" class="response">[0]</span>' is the final TIN and it was last processed on <span id="tin-last-timestamp" class="response">[LAST TIMESTAMP]</span> in <span id="tin-minutes" class="response">[FIRST - LAST TIMESTAMP]</span>. According to the crew, the TIN was <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q04']/Response" /></span> to edit. If TIN errors were present, repairs were made <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q05']/Response" /></span>. The amount of editing done to the final TIN surface was <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q07']/Response" /></span>. The following errors were found while editing and reviewing the TIN: <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q06']/Response" /></span> . The crew considered the quality of the TIN produced as <span class="response"><xsl:value-of select ="/surveyGDB/tables/table/records/record[QuestionID = 'Q08']/Response" /></span>.</p>
              <p>In this survey, edits included the addition of <span id="nodes-added" class="response">[0]</span> nodes and deletion of <span id="nodes-deleted" class="response">[0]</span> nodes for a net change of <span id="nodes-delta">[0]</span>.  <span id="nodes-topo" class="response">[0]</span> of the nodes originate from Topo Points.  There are <span id="nodes-not-topo" class="response">[0]</span> topo points that are not nodes in the TIN. The survey includes <span id="bl-count" class="response">[0]</span> breakline(s).  Dams <span id="dams-remove" class="response"></span> found during TIN editing and facets <span id="facets-remove" class="response"></span> found during editing. TIN editing changed the minimum node elevation by <span id="nodes-Zmax" class="response">[0]</span> and the maximum node elevation by <span id="nodes-Zmin" class="response">[0]</span>.</p>
