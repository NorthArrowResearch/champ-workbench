...
{
    class BatchVisit : NamedDBObject
    {
        ...
        public BatchVisit(int nID, String sHitch, String sCrew, int nFieldSeason, String sFileGDB, String sTopoTIN, String sWSTIN, DateTime dSampleDate, bool bTarget, bool bPrimary)
            : base(nID, sHitch)
        {
            m_nVisitID = nID;
            m_sHitch = sHitch;
        ...
        public BatchVisit(RBTWorkbenchDataSet.CHAMP_VisitsRow rVisit, string sSurveyGDB, string sTopoTIN, string sWSTIN, bool bCalculateMetrics, bool bChangeDetection, bool bDEMOrthogonal, bool bGenerateCSVs, bool bForcePrimary)
